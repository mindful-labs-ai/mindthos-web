    ...
    <div className="flex h-dvh flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-10 pt-6 text-sm font-medium leading-[150%] text-grey-100">
        ...
        <p className="mt-3">
          ...
          있으나, 비회원 이용자 자신의 심리검사 및 상담서비스 내용 확인할 수 없는
          등 일부 서비스 이용의 제한이 있을 수 있습니다.
        </p>
        ...
        <ul className="mt-3 flex flex-col gap-3">
          ...
          <li>
            ...
            <br />상담자가 이용자에게 발송한 상담신청서 및 심화면접지 등
        ...
        <p className="mt-3">
          ...
          나머지 부분은 대하여는 회원과 동일하게 개인정보처리방침이 적용되며, 해당
          용도 외에는 다른 어떠한 용도로도 사용되지 않습니다.
        </p>
        <p className="mt-3">
