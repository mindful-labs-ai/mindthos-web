...
const TUTORIAL_VIDEO_SOURCE = {
  OVERVIEW: '/tutorial/mindthos-tutorial-overview-v1.mp4',
  ...
  GENOGRAM: '/tutorial/mindthos-tutorial-genogram-v1.mp4',
  SELECT_NOTE: '/tutorial/mindthos-tutorial-selectnote-v1.mp4',
  UPLOAD: '/tutorial/mindthos-tutorial-upload-v1.mp4',
} as const;

/**
 * 단계 성격별 전용 영상을 연결한다. 새 버전 영상이 오면
 * TUTORIAL_VIDEO_SOURCE의 src만 교체한다.
 */
export const GUIDE_VIDEO_SOURCES: Record<TutorialStep, string> = {
  ...
  [TutorialStep.GENOGRAM_STAGE_2]: TUTORIAL_VIDEO_SOURCE.GENOGRAM,
  [TutorialStep.GENOGRAM_STAGE_3]: TUTORIAL_VIDEO_SOURCE.SELECT_NOTE,
  [TutorialStep.GENOGRAM_STAGE_4]: TUTORIAL_VIDEO_SOURCE.UPLOAD,
  ...
  [TutorialStep.CBT_STAGE_3]: TUTORIAL_VIDEO_SOURCE.SELECT_NOTE,
  [TutorialStep.CBT_STAGE_4]: TUTORIAL_VIDEO_SOURCE.UPLOAD,
  ...
  [TutorialStep.PSYCHODYNAMIC_STAGE_3]: TUTORIAL_VIDEO_SOURCE.SELECT_NOTE,
  [TutorialStep.PSYCHODYNAMIC_STAGE_4]: TUTORIAL_VIDEO_SOURCE.UPLOAD,
  ...
  [TutorialStep.HUMANISTIC_STAGE_3]: TUTORIAL_VIDEO_SOURCE.SELECT_NOTE,
  [TutorialStep.HUMANISTIC_STAGE_4]: TUTORIAL_VIDEO_SOURCE.UPLOAD,
  ...
  [TutorialStep.GENERIC_STAGE_3]: TUTORIAL_VIDEO_SOURCE.SELECT_NOTE,
  [TutorialStep.GENERIC_STAGE_4]: TUTORIAL_VIDEO_SOURCE.UPLOAD,
};
