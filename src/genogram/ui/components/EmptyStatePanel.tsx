...
export const EmptyStatePanel: React.FC<EmptyStatePanelProps> = ({
  ...
  return (
    ...
    >
      <div className="flex w-[512px] flex-col justify-center rounded-lg border border-dashed border-border bg-white/80 p-8 text-center backdrop-blur-sm">
        ...
        {actions && (
          <div className="pointer-events-auto mt-4 flex justify-center border-t border-border pt-4">
            {actions}
          </div>
        )}
      </div>
