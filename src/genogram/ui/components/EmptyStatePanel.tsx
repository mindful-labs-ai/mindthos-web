...
export const EmptyStatePanel: React.FC<EmptyStatePanelProps> = ({
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-[512px] flex-col justify-center rounded-lg border border-dashed border-border bg-white/80 p-8 text-center backdrop-blur-sm">
