  ...
  return (
    <div className="absolute right-0 top-0 z-10 h-full w-80 overflow-y-auto border-l border-grey-40 bg-white shadow-elevated">
      ...
      <div className="px-5 pt-5">
        <h2 className="text-lg font-headline text-grey-100">텍스트</h2>
      </div>
      ...
      <div className="flex flex-col gap-5 px-5 py-5">
        {/* 내용 */}
        <section>
          <h3 className="mb-2 text-m font-medium text-grey-100">내용</h3>
          <textarea
            ref={textareaRef}
        ...
        <section className="flex items-center justify-between">
          <h3 className="text-m font-medium text-grey-100">글씨 크기</h3>
          <InlineDropdown
        ...
        {/* 배경 색상 */}
        <section className="flex items-center justify-between">
          <h3 className="text-m font-medium text-grey-100">배경 색상</h3>
          <ColorPicker
