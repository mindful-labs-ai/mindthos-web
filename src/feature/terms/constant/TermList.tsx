...
export const serviceTermsItems: AccordionItem[] = [
  {
    ...
    content: (
      <div className="space-y-2">
        <p>
          본 약관은 마인드풀랩스 주식회사(이하 "회사"라 합니다)가 제공하는 상담
          관리 및 AI 분석 지원 서비스인 마음토스(Mindthos) 및 관련 제반
          서비스(이하 "서비스"라 합니다)를 이용함에 있어 회사와 회원 간의 권리,
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p>
          1. "서비스"란 단말기(PC, 휴대형 단말기 등)에 상관없이 회원이 이용할 수
          있는 마음토스 및 관련 제반 서비스를 의미합니다.
        </p>
        <p>
        ...
        <p>
          3. "크레딧(Credit)"이란 서비스를 이용하기 위해 사용되는 가상의 데이터
          단위를 의미하며, 회원은 이를 유상으로 구매하거나 회사의 정책에 따라
          무상으로 지급받을 수 있습니다.
        </p>
        <p>
        ...
        <p>
          5. "AI 분석 결과"란 상담 데이터를 바탕으로 회사의 알고리즘이 생성한
          축어록, 요약, 분석 리포트, 슈퍼비전 제안 등을 의미합니다.
        </p>
      </div>
    ),
  },
  {
    value: '3',
    header: '제 3 조 (약관의 게시와 개정)',
    content: (
      <div className="space-y-2">
        <p>
          1. 회사는 본 약관의 내용을 회원이 쉽게 확인할 수 있도록 서비스 초기
          화면 또는 설정 메뉴에 게시합니다.
        </p>
        <p>
        ...
        <p>
          ...
          현행약관과 함께 개정약관 적용일 7일 전부터 공지합니다. 단, 회원에게
          불리한 변경의 경우 30일 전부터 공지하고 이메일 등으로 개별 통지합니다.
        </p>
      </div>
    ),
  },
  {
    value: '4',
    header: '제 4 조 (이용계약 체결)',
    content: (
      <div className="space-y-2">
        <p>
          1. 이용계약은 회원이 되고자 하는 자(이하 "가입신청자")가 약관의 내용에
          동의하고 가입을 신청한 후, 회사가 이를 승낙함으로써 체결됩니다.
        </p>
        <p>
          2. 회사는 가입신청자가 만 14세 미만이거나, 타인의 정보를 도용하거나,
          허위 정보를 기재한 경우 승낙을 거부하거나 사후에 이용계약을 해지할 수
          있습니다.
        </p>
      </div>
    ),
  ...
  {
    value: '5',
    header: '제 5 조 (개인정보보호 및 데이터 보안)',
    content: (
      <div className="space-y-2">
        <p>
          1. 회사는 「개인정보보호법」 등 관계 법령이 정하는 바에 따라 회원의
          개인정보를 보호하기 위해 노력합니다.
        </p>
        <p>
        ...
        <p>
          3. 회사는 상담 데이터 보호를 위해 업계 표준 이상의 암호화 기술(AES-256
          등)을 적용하며, 데이터에 대한 접근 통제를 엄격히 수행합니다.
        </p>
      </div>
    ),
  },
  {
    value: '6',
    header: '제 6 조 (서비스의 제공 및 변경)',
    content: (
      <div className="space-y-2">
        <p>1. 회사는 다음과 같은 서비스를 제공합니다.</p>
        <p>① 음성 녹음 및 업로드 기능</p>
        <p>② STT(Speech-to-Text) 기반 축어록 생성</p>
        <p>③ AI 기반 상담 요약, 분석 및 슈퍼비전 제안</p>
        <p>④ 내담자 관리 및 상담 일정 관리 기능</p>
        <p>
          2. 회사는 기술적 사양의 변경이나 운영상의 필요에 따라 서비스의 전부
          또는 일부를 변경하거나 중단할 수 있습니다.
        </p>
      </div>
    ),
  },
  {
    value: '7',
    header: '제 7 조 (서비스 이용의 제한 및 면책)',
    content: (
      <div className="space-y-2">
        <p>
          1. <strong>[의료 행위 아님]</strong> 본 서비스가 제공하는 분석 결과 및
          슈퍼비전 제안은 상담을 돕기 위한 보조 자료일 뿐이며, 의학적 진단이나
          확정적인 심리 평가를 대체할 수 없습니다. 최종적인 임상적 판단과 책임은
          회원 본인에게 있습니다.
        </p>
        <p>
          2. <strong>[AI 기술의 한계]</strong> AI 분석 결과는 기술적 특성상
          환각(Hallucination) 현상이나 부정확한 내용이 포함될 수 있습니다.
          회원은 반드시 원본 데이터와 대조하여 내용을 확인해야 하며, 회사는 분석
          결과의 완전성, 무결성을 보증하지 않습니다.
        </p>
      </div>
    ),
  },
  {
    value: '8',
    header: '제 8 조 (크레딧 및 유료 서비스)',
    content: (
      <div className="space-y-2">
        <p>
          1. 회사는 서비스를 이용할 수 있는 크레딧을 정기 구독 상품 또는 단건
          충전 상품 형태로 제공합니다.
        </p>
        <p>
          2. 크레딧의 차감 기준, 유효기간, 소멸 정책 등 상세 내용은 서비스 내
          별도 고지된 정책을 따릅니다.
        </p>
        <p>
  ...
  {
    value: '9',
    header: '제 9 조 (청약철회 및 환불)',
    content: (
      <div className="space-y-2">
        <p>
          1. 회원은 유료 결제 후 7일 이내에 사용 내역이 없는 경우 청약철회(전액
          환불)를 할 수 있습니다.
        </p>
        <p>
          2. 크레딧 사용 후, 또는 정기 구독 서비스 이용 중 해지 시 환불 규정 등
          상세 내용은 서비스 내 별도 고지된 정책을 따릅니다.
        </p>
        <p>
          3. 환불 시 결제 수수료 등 부대 비용을 공제할 수 있으며, 애플 앱스토어
          등 제3자 마켓을 통한 결제는 해당 마켓의 환불 정책을 따릅니다.
        </p>
      </div>
    ),
  },
  {
    value: '10',
    header: '제 10 조 (회원의 의무)',
    content: (
      <div className="space-y-2">
        <p>
          1. 회원은 서비스를 이용하여 상담 내담자의 개인정보나 민감정보를
          처리함에 있어 의료법, 개인정보보호법 등 관련 법령을 준수해야 할 책임이
          있습니다.
        </p>
        <p>
          2. 회원은 본인의 계정 정보를 제3자와 공유해서는 안 되며, 계정 공유로
          인해 발생한 데이터 유출 등의 사고에 대해 회사는 책임을 지지 않습니다.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>
          2. 회사는 서비스 이용과 관련하여 회원으로부터 제기된 의견이나 불만이
          정당하다고 인정할 경우에는 이를 처리해야 합니다.
        </p>
      </div>
    ),
  },
  ...
  {
    value: '13',
    header: '제 13 조 (재판권 및 준거법)',
    content: (
      <div className="space-y-2">
        <p>
          본 약관과 관련하여 회사와 회원 간에 발생한 분쟁에 대해서는 대한민국의
