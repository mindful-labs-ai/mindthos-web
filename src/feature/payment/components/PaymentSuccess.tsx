...
export const PaymentSuccess = () => {
  ...
  useEffect(() => {
    ...
    const handleCompletePlanUpgrade = async () => {
      ...
      // planId가 있으면 플랜 업그레이드 완료, 없으면 단순 카드 등록
      if (!planId) {
        toast({
          title: '잘못된 요청',
          description: 'planId가 누락되었습니다.',
        });
        navigate('/settings');
        return;
      }
      ...
      try {
        ...
        // complete-upgrade 호출: 빌링키 발급 + 결제 + 구독 생성
