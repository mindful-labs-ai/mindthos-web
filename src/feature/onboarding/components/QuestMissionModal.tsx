      ...
      <div className="flex flex-col items-center px-8 py-6 text-center">
        ...
        <div className="relative mt-10 w-full">
          ...
          >
            ...
            <div className="absolute left-1/2 top-3 flex w-full -translate-x-1/2 flex-col items-center text-white">
              <span className="text-base font-bold uppercase tracking-[1em] opacity-80">
                COUPON
              </span>
            </div>
