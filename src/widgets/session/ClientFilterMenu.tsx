      ...
      {showCtaButton && (
        <div className="flex-shrink-0 border-t border-grey-30 pt-3">
          <button
            ...
            className="lg:hover:bg-green-80/90 w-full rounded-lg bg-green-80 py-3 text-m font-medium text-white transition-colors disabled:cursor-not-allowed disabled:bg-grey-40 disabled:text-grey-70"
          >
