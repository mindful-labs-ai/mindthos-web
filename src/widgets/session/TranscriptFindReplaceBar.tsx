...
> = ({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg border border-grey-40 bg-white shadow-sm">
      {/* 1행: 찾기 */}
      <div className="flex flex-wrap items-center gap-2 border-b border-grey-40 p-3">
        <Input
          size="sm"
          value={find}
      ...
      <div className="flex flex-wrap items-center gap-2 bg-grey-10 p-3">
        <Input
          size="sm"
          value={replaceWith}
        ...
        <Button
          ...
          disabled={count === 0}
          className="border border-grey-100 bg-white text-grey-100 disabled:border-grey-40 disabled:bg-white disabled:text-grey-40 lg:hover:bg-grey-10"
        >
          바꾸기
        </Button>
        <Button
