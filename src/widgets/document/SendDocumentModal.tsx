...
export function SendDocumentModal({
  ...
  return (
    <Modal
      ...
      className="max-h-[90vh] max-w-[648px] rounded-2xl px-10 pb-10 pt-10"
    >
        ...
        <div>
          ...
          <div className="mt-3 rounded-lg border border-grey-40 bg-[#A5C2D3] px-6 py-6">
            ...
            <div className="relative mx-auto w-[286px]">
              <span className="absolute -left-[60px] top-0 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border border-grey-40 bg-grey-10">
                <img
      ...
      <button
        ...
        onClick={handleSend}
        disabled={!canSend}
        className={`mx-auto mt-10 block h-[41px] w-[396px] max-w-full rounded-lg text-m font-medium text-white transition-opacity ${
          canSend
