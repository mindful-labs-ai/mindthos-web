...
const CreateMultiSessionModal = lazy(() =>
  import('@/widgets/session/CreateMultiSessionModal').then((m) => ({
    default: m.CreateMultiSessionModal,
  }))
);
const CouponBox = lazy(() =>
  import('@/widgets/settings/CouponBox').then((m) => ({
    default: m.CouponBox,
  }))
);
const PlanChangeModal = lazy(() =>
  import('@/widgets/settings/PlanChangeModal').then((m) => ({
    default: m.PlanChangeModal,
  }))
);
const UserEditModal = lazy(() =>
  import('@/widgets/settings/UserEditModal').then((m) => ({
