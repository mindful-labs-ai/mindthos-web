...
function NoticeCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="lg:hover:border-primary-500 flex w-full cursor-pointer overflow-hidden rounded-2xl border border-border bg-surface text-left transition-colors"
    >
      {notice.thumbnail && (
        <img
