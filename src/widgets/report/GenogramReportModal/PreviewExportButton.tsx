  ...
  if (isComplete) {
    return (
      <button
        ...
        className="typo-m w-full rounded-xl border border-primary py-3.5 text-center font-emphasize text-primary transition-colors hover:bg-primary hover:text-primary-fg"
      >
        목록으로 돌아가기
      </button>
    );
