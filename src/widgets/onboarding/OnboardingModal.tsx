...
import { OnboardingStep } from '@/shared/api/services/onboarding/types';
...
export function OnboardingModal() {
  ...
  return (
    <div
      className="fixed inset-0 z-modal flex items-center justify-center bg-overlay-bg backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
