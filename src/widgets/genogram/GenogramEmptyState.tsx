...
export function GenogramEmptyState({
  ...
  const desktopButtonStyle =
    'flex h-[326px] w-[327px] flex-col items-center justify-end gap-2.5 rounded-2xl border border-border bg-surface px-6 pb-[36px] shadow-subtle transition-all lg:hover:border-primalg:hover:hover:shadow-default disabled:disabled-default';

  const tabletButtonStyle =
    'flex flex-1 flex-col items-center justify-end gap-2.5 rounded-2xl border border-grey-30 bg-white px-6 pb-6 pt-4 shadow-subtle transition-all lg:hover:border-green-lg:hover:hover:shadow-default disabled:opacity-50';

  const mobileButtonStyle =
    'flex h-[203px] w-full flex-col items-center justify-end gap-2.5 rounded-2xl border border-grey-30 bg-white px-6 pb-6 pt-4 shadow-subtle transition-all lg:hover:border-green-lg:hover:hover:shadow-default disabled:opacity-50';
